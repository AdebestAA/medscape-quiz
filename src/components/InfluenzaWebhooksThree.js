...
const InfluenzaWebhooksThree = ({dataFromTypeForm}) => {
...
console.log(dataFromTypeForm);
 ...
 mutation deleteInfluenzaWebhooksThree($id: ID!) {
    deleteInfluenzaWebhooksThree(where: { id: $id }) {
      id
    }
  }
`;
...
const createQuestMutation = gql`
 mutation createInfluenzaWebhooksThree($data: InfluenzaWebhooksThreeCreateInput!) {
    createInfluenzaWebhooksThree(data: $data) {
      id
      placeholder
    }
  }
...
const publishQuestMutation = gql`
  mutation publishInfluenzaWebhooksThree($id: ID!) {
    publishInfluenzaWebhooksThree(where: { id: $id }) {
      id
      placeholder
      publishedAt
    }
...
async function tryT() {
  ...
  placeholder: {name:"james"}
    ...
    //   fields: newData,
    // });
    const questId = newQuest.createInfluenzaWebhooksThree.id;
...
const overwriteAndPublishQuest = async (newData) => {
  try {
    ...
    query getExistingInfluenzaWebhooksThrees {
   influenzaWebhooksThrees {
    id
    placeholder
    }
    }
    ...
    if (existingData.influenzaWebhooksThrees.length > 0) {
      // Step 2: Delete the existing quest
      const questId = existingData.influenzaWebhooksThrees[0].id;
  ...
  placeholder: newData
   ...
   setDataPosted(()=> {
    if (publishedQuest.publishInfluenzaWebhooksThree.id) {
      return true
    }
    else{
      false
...
console.log(dataFromTypeForm);
  ...
  useEffect(() => {
    ...
    const fetchInfluenzaWebhooksThreeData = async () => {
      const query = gql`
        query {
            influenzaWebhooksThrees {
            id
      ...
      try {
        ...
        console.log(getData.influenzaWebhooksThrees[0]);
        setQuestionsToDisplay(getData.influenzaWebhooksThrees)
   ...
   fetchInfluenzaWebhooksThreeData();
  }, [dataPosted]);
...
export default InfluenzaWebhooksThree