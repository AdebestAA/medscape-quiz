...
const MyelodysplasticSyndromeWebhooks = ({dataFromTypeForm}) => {
...
console.log(dataFromTypeForm);
 ...
 mutation deleteMyelodysplasticSyndromeWebhook($id: ID!) {
    deleteMyelodysplasticSyndromeWebhook(where: { id: $id }) {
      id
    }
  }
`;
...
const createQuestMutation = gql`
 mutation createMyelodysplasticSyndromeWebhook($data: MyelodysplasticSyndromeWebhookCreateInput!) {
    createMyelodysplasticSyndromeWebhook(data: $data) {
      id
      placeholder
    }
  }
...
const publishQuestMutation = gql`
  mutation publishMyelodysplasticSyndromeWebhook($id: ID!) {
    publishMyelodysplasticSyndromeWebhook(where: { id: $id }) {
      id
      placeholder
      publishedAt
    }
...
async function tryT() {
  ...
  placeholder: {name:"james"}
    ...
    //   fields: newData,
    // });
    const questId = newQuest.createMyelodysplasticSyndromeWebhook.id;
...
const overwriteAndPublishQuest = async (newData) => {
  try {
    ...
    query getExistingMyelodysplasticSyndromeWebhooks {
   myelodysplasticSyndromeWebhooks {
    id
    placeholder
    }
    }
    ...
    if (existingData.myelodysplasticSyndromeWebhooks.length > 0) {
      // Step 2: Delete the existing quest
      const questId = existingData.myelodysplasticSyndromeWebhooks[0].id;
  ...
  placeholder: newData
   ...
   setDataPosted(()=> {
    if (publishedQuest.publishMyelodysplasticSyndromeWebhook.id) {
      return true
    }
    else{
      false
...
console.log(dataFromTypeForm);
  ...
  useEffect(() => {
    ...
    const fetchMyelodysplasticSyndromeWebhookData = async () => {
      const query = gql`
        query {
            myelodysplasticSyndromeWebhooks {
            id
      ...
      try {
        ...
        console.log(getData.myelodysplasticSyndromeWebhooks[0]);
        setQuestionsToDisplay(getData.myelodysplasticSyndromeWebhooks)
   ...
   fetchMyelodysplasticSyndromeWebhookData();
  }, [dataPosted]);
...
export default MyelodysplasticSyndromeWebhooks