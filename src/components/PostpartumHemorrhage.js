...
const PostpartumHemorrhage = ({dataFromTypeForm}) => {
...
console.log(dataFromTypeForm);
 ...
 mutation deletePostpartumHemorrhage($id: ID!) {
    deletePostpartumHemorrhage(where: { id: $id }) {
      id
    }
  }
`;
...
const createQuestMutation = gql`
 mutation createPostpartumHemorrhage($data: PostpartumHemorrhageCreateInput!) {
    createPostpartumHemorrhage(data: $data) {
      id
      placeholder
    }
  }
...
const publishQuestMutation = gql`
  mutation publishPostpartumHemorrhage($id: ID!) {
    publishPostpartumHemorrhage(where: { id: $id }) {
      id
      placeholder
      publishedAt
    }
...
async function tryT() {
  ...
  placeholder: {name:"james"}
    ...
    //   fields: newData,
    // });
    const questId = newQuest.createPostpartumHemorrhage.id;
...
const overwriteAndPublishQuest = async (newData) => {
  try {
    ...
    query getExistingPostpartumHemorrhages {
   postpartumHemorrhages {
    id
    placeholder
    }
    }
    ...
    if (existingData.postpartumHemorrhages.length > 0) {
      // Step 2: Delete the existing quest
      const questId = existingData.postpartumHemorrhages[0].id;
  ...
  placeholder: newData
   ...
   setDataPosted(()=> {
    if (publishedQuest.publishPostpartumHemorrhage.id) {
      return true
    }
    else{
      false
...
console.log(dataFromTypeForm);
  ...
  useEffect(() => {
    ...
    const fetchPostpartumHemorrhageData = async () => {
      const query = gql`
        query {
            postpartumHemorrhages {
            id
      ...
      try {
        ...
        console.log(getData.postpartumHemorrhages[0]);
        setQuestionsToDisplay(getData.postpartumHemorrhages)
...
export default PostpartumHemorrhage
